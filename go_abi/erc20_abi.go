...
var ERC20ExtendedFuncSigs = map[string]string{
	...
	"095ea7b3": "approve(address,uint256)",
	"70a08231": "balanceOf(address)",
	"b8527682": "bindContractAddrWithChainId(uint64,bytes)",
	"42966c68": "burn(uint256)",
	"d88c2999": "contractAddrBindChainId(uint64)",
	"313ce567": "decimals()",
	"a457c2d7": "decreaseAllowance(address,uint256)",
	"39509351": "increaseAllowance(address,uint256)",
...
// ContractAddrBindChainId is a free data retrieval call binding the contract method 0xd88c2999.
//
// Solidity: function contractAddrBindChainId(uint64 ) view returns(bytes)
func (_ERC20Extended *ERC20ExtendedCaller) ContractAddrBindChainId(opts *bind.CallOpts, arg0 uint64) ([]byte, error) {
	var (
		ret0 = new([]byte)
	)
	out := ret0
	err := _ERC20Extended.contract.Call(opts, out, "contractAddrBindChainId", arg0)
	return *ret0, err
}
...
//
// Solidity: function contractAddrBindChainId(uint64 ) view returns(bytes)
func (_ERC20Extended *ERC20ExtendedSession) ContractAddrBindChainId(arg0 uint64) ([]byte, error) {
	return _ERC20Extended.Contract.ContractAddrBindChainId(&_ERC20Extended.CallOpts, arg0)
}

// ContractAddrBindChainId is a free data retrieval call binding the contract method 0xd88c2999.
//
// Solidity: function contractAddrBindChainId(uint64 ) view returns(bytes)
func (_ERC20Extended *ERC20ExtendedCallerSession) ContractAddrBindChainId(arg0 uint64) ([]byte, error) {
	return _ERC20Extended.Contract.ContractAddrBindChainId(&_ERC20Extended.CallOpts, arg0)
}
...
// BindContractAddrWithChainId is a paid mutator transaction binding the contract method 0xb8527682.
//
// Solidity: function bindContractAddrWithChainId(uint64 chainId, bytes contractAddr) returns()
func (_ERC20Extended *ERC20ExtendedTransactor) BindContractAddrWithChainId(opts *bind.TransactOpts, chainId uint64, contractAddr []byte) (*types.Transaction, error) {
	return _ERC20Extended.contract.Transact(opts, "bindContractAddrWithChainId", chainId, contractAddr)
}

// BindContractAddrWithChainId is a paid mutator transaction binding the contract method 0xb8527682.
//
// Solidity: function bindContractAddrWithChainId(uint64 chainId, bytes contractAddr) returns()
func (_ERC20Extended *ERC20ExtendedSession) BindContractAddrWithChainId(chainId uint64, contractAddr []byte) (*types.Transaction, error) {
	return _ERC20Extended.Contract.BindContractAddrWithChainId(&_ERC20Extended.TransactOpts, chainId, contractAddr)
}

// BindContractAddrWithChainId is a paid mutator transaction binding the contract method 0xb8527682.
//
// Solidity: function bindContractAddrWithChainId(uint64 chainId, bytes contractAddr) returns()
func (_ERC20Extended *ERC20ExtendedTransactorSession) BindContractAddrWithChainId(chainId uint64, contractAddr []byte) (*types.Transaction, error) {
	return _ERC20Extended.Contract.BindContractAddrWithChainId(&_ERC20Extended.TransactOpts, chainId, contractAddr)
}
...
// ERC20ExtendedBindContractAddrWithChainIdEventIterator is returned from FilterBindContractAddrWithChainIdEvent and is used to iterate over the raw logs and unpacked data for BindContractAddrWithChainIdEvent events raised by the ERC20Extended contract.
type ERC20ExtendedBindContractAddrWithChainIdEventIterator struct {
	Event *ERC20ExtendedBindContractAddrWithChainIdEvent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20ExtendedBindContractAddrWithChainIdEventIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20ExtendedBindContractAddrWithChainIdEvent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20ExtendedBindContractAddrWithChainIdEventIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20ExtendedBindContractAddrWithChainIdEventIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20ExtendedBindContractAddrWithChainIdEvent represents a BindContractAddrWithChainIdEvent event raised by the ERC20Extended contract.
type ERC20ExtendedBindContractAddrWithChainIdEvent struct {
	ChainId      uint64
	ContractAddr []byte
	Raw          types.Log // Blockchain specific contextual infos
}

// FilterBindContractAddrWithChainIdEvent is a free log retrieval operation binding the contract event 0xcc0c014035338c3e1395681793b8b3a5fb0a3d4aa40c9d667da3e92257252f4c.
//
// Solidity: event BindContractAddrWithChainIdEvent(uint64 chainId, bytes contractAddr)
func (_ERC20Extended *ERC20ExtendedFilterer) FilterBindContractAddrWithChainIdEvent(opts *bind.FilterOpts) (*ERC20ExtendedBindContractAddrWithChainIdEventIterator, error) {

	logs, sub, err := _ERC20Extended.contract.FilterLogs(opts, "BindContractAddrWithChainIdEvent")
	if err != nil {
		return nil, err
	}
	return &ERC20ExtendedBindContractAddrWithChainIdEventIterator{contract: _ERC20Extended.contract, event: "BindContractAddrWithChainIdEvent", logs: logs, sub: sub}, nil
}

// WatchBindContractAddrWithChainIdEvent is a free log subscription operation binding the contract event 0xcc0c014035338c3e1395681793b8b3a5fb0a3d4aa40c9d667da3e92257252f4c.
//
// Solidity: event BindContractAddrWithChainIdEvent(uint64 chainId, bytes contractAddr)
func (_ERC20Extended *ERC20ExtendedFilterer) WatchBindContractAddrWithChainIdEvent(opts *bind.WatchOpts, sink chan<- *ERC20ExtendedBindContractAddrWithChainIdEvent) (event.Subscription, error) {

	logs, sub, err := _ERC20Extended.contract.WatchLogs(opts, "BindContractAddrWithChainIdEvent")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20ExtendedBindContractAddrWithChainIdEvent)
				if err := _ERC20Extended.contract.UnpackLog(event, "BindContractAddrWithChainIdEvent", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBindContractAddrWithChainIdEvent is a log parse operation binding the contract event 0xcc0c014035338c3e1395681793b8b3a5fb0a3d4aa40c9d667da3e92257252f4c.
//
// Solidity: event BindContractAddrWithChainIdEvent(uint64 chainId, bytes contractAddr)
func (_ERC20Extended *ERC20ExtendedFilterer) ParseBindContractAddrWithChainIdEvent(log types.Log) (*ERC20ExtendedBindContractAddrWithChainIdEvent, error) {
	event := new(ERC20ExtendedBindContractAddrWithChainIdEvent)
	if err := _ERC20Extended.contract.UnpackLog(event, "BindContractAddrWithChainIdEvent", log); err != nil {
		return nil, err
	}
...
var ERC20TemplateBin = ""
