...
contract EthCrossChainData is IEthCrossChainData, Ownable, Pausable{
    ...
    */
    ...
    function putCurEpochConPubKeyBytes(bytes curEpochPkBytes) external whenNotPaused onlyOwner returns (bool) {
    ...
    function putExtraData(bytes32 key1, bytes32 key2, bytes value) external whenNotPaused onlyOwner returns (bool) {
