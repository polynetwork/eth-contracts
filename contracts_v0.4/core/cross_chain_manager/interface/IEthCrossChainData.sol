...
interface IEthCrossChainData {
    ...
    function putCurEpochConPubKeyBytes(bytes curEpochPkBytes) external returns (bool);
    ...
    function putExtraData(bytes32 key1, bytes32 key2, bytes value) external returns (bool);
