...
contract EthCrossChainManagerV2 is IEthCrossChainManager, UpgradableECCM {
    ...
    */
    ...
    bool changed = false;
    uint32 constant newEpochStartHeight = 1; // TODO
    bytes constant newBookerKeeperPubkeyList = hex""; // TODO
