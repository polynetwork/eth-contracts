...
contract ZeroCopySinkMock {
    uint N = 10;
    function WriteBool(bool _b) public view returns (bytes memory) {
    ...
    function WriteByte(byte _b) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteUint8(uint8 _v) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteUint16(uint16 _v) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteUint32(uint32 _v) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteUint64(uint64 _v) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteUint255(uint256 _v) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteVarBytes(bytes memory _b) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
    ...
    function WriteVarUint(uint64 _v) public view returns (bytes memory) {
        bytes memory executeResult;
        for (uint i = 0; i <= N; i++) {
