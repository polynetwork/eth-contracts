...
contract ZeroCopySourceMock {
    ...
    function NextBool(bytes memory _b, uint256 _off) public pure returns (bool, uint256) {
    ...
    function NextUint16(bytes memory _b, uint256 _off) public pure returns (uint16, uint256) {
        return ZeroCopySource.NextUint16(_b, _off);
    }

    function NextUint32(bytes memory _b, uint256 _off) public pure returns (uint32, uint256) {
        return ZeroCopySource.NextUint32(_b, _off);
    }

    function NextUint64(bytes memory _b, uint256 _off) public pure returns (uint64, uint256) {
        return ZeroCopySource.NextUint64(_b, _off);
    }

    function NextVarBytes(bytes memory _b, uint256 _off) public pure returns (bytes memory, uint256) {
        return ZeroCopySource.NextVarBytes(_b, _off);
    }

    function NextHash(bytes memory _b, uint256 _off) public pure returns (bytes32, uint256) {
...
//    }
    ...
    function NextBytes20(bytes memory _b, uint256 _off) public pure returns (bytes20, uint256) {
        return ZeroCopySource.NextBytes20(_b, _off);
    }

    function NextUint255(bytes memory _b, uint256 _off) public pure returns (uint256, uint256) {
        return ZeroCopySource.NextUint255(_b, _off);
    }
    function NextVarUint(bytes memory _b, uint256 _off) public pure returns (uint, uint256) {
